...
![JWT](https://img.shields.io/badge/JWT-python--jose-000000?style=flat&logo=jsonwebtokens&logoColor=white)
...
![Alembic](https://img.shields.io/badge/Alembic-Migration-6BA81E?style=flat)
![Loguru](https://img.shields.io/badge/Loguru-Logging-blue?style=flat)
![Ruff](https://img.shields.io/badge/Ruff-Linter-D7FF64?style=flat)
![Mypy](https://img.shields.io/badge/Mypy-TypeCheck-2A6DB2?style=flat)
![Pytest](https://img.shields.io/badge/Pytest-Testing-0A9EDC?style=flat)

---

## 기술 스택 선택 이유

파이썬 웹 어플리케이션 설계 프로젝트 시행시 FastAPI 활용 및 내장 라이브러리 활용을 위해 사용
파이썬 언어의 강점인 AI 기능을 적극 도입하기 openAI와 Streamlit을 사용하여 AI chat bot 프로그램을 구현
